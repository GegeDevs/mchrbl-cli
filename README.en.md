...
5. All output is automatically written to a log file `~/mchrbl-cli/log/ubl-<timestamp>.log` — check that folder to see the war results after detaching from tmux.
